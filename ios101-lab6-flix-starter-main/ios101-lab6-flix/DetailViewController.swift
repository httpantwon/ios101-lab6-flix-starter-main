...
//  ios101-lab6-flix
//
//  Created by Antwon Walls on 3/26/24.
//
...
class DetailViewController: UIViewController {
    ...
    @IBOutlet weak var posterImageViewLarge: UIImageView!
    @IBOutlet weak var posterImageViewSmall: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        if let releaseDate = movie.releaseDate {
            ...
            self.releaseDate.text = "Release Date: \(releaseDateString)"
        } else {
        ...
        if let posterPath = movie.posterPath,
           ...
           let imageUrl = URL(string: "https://image.tmdb.org/t/p/w500" + posterPath) {
            ...
            Nuke.loadImage(with: imageUrl, into: posterImageViewSmall)
        }
        ...
        if let backdropPath = movie.backdropPath,
           ...
           let imageUrl = URL(string: "https://image.tmdb.org/t/p/w500" + backdropPath) {
            ...
            // Use the Nuke library's load image function to (async) fetch and load the image from the image url.
            Nuke.loadImage(with: imageUrl, into: posterImageViewLarge)
        }
